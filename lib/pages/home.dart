...
class _HomeState extends State<Home> {
  ...
  void filterNews(String query) {
    ...
    if (query.isEmpty) {
      results = articles; // Show all articles if query is empty
    } else {
    ...
    setState(() {
      filteredArticles = results; // Update filtered articles
    });
  }
                ...
                child: ListView(
                  children: [
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      /* reference from https://stackoverflow.com/a/65056354 */
                      physics: const ClampingScrollPhysics(),
                      itemCount:
                          filteredArticles.length, // Use filtered articles
                      itemBuilder: (context, index) {
                        return BlogTile(
...
class CatergoryTile extends StatelessWidget {
  ...
  CatergoryTile({this.categoryName, this.image});
